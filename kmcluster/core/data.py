...
class energy_data(): 
    ...
    def __init__(self, energies=None, rates=None, file_energies=None, file_rates=None): 
        ...
        assert (energies is not None) or (file_energies is not None), 'must provide energies list or filename for energies'
        # assert that either rates or file_rates is not None
        assert (rates is not None) or (file_rates is not None), 'must provide rate matrix or filename for rates'
