...
if __name__ == "__main__":
    ...
    #rkmc_obj = rkmc(k_b_t=temp_boltz)
    ...
    file = "./checkpoints/trajectories_5_ckpt_start_0_end_5.00000e-05_step_5.00000e-07.npy"
    ...
    print("kmc done")
    kmc_boltz.save_as_dict("Pt4H2_g_150K_0.0001s.json",start_time=0,end_time=time_stop,step=0.000001)
    print("saving done")
